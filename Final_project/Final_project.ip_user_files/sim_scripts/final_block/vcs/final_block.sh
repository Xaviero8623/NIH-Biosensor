...
#
# Script generated by Vivado on Wed Jul 17 10:38:40 -0400 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : final_block.sh
...
#
# Usage        : final_block.sh
#                final_block.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                final_block.sh [-reset_run]
#                final_block.sh [-reset_log]
#                final_block.sh [-help]
#
...
#                script (type 'final_block.sh -help' for more information).
#
...
# script info
echo -e "final_block.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./final_block.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../Final_project.gen/sources_1/bd/final_block/ipshared/ec67/hdl" +incdir+"../../../../Final_project.gen/sources_1/bd/final_block/ipshared/b28c/hdl" +incdir+"C:/Xilinx2/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../Final_project.gen/sources_1/bd/final_block/ipshared/ec67/hdl" +incdir+"../../../../Final_project.gen/sources_1/bd/final_block/ipshared/b28c/hdl" +incdir+"C:/Xilinx2/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../Final_project.gen/sources_1/bd/final_block/ipshared/ec67/hdl" +incdir+"../../../../Final_project.gen/sources_1/bd/final_block/ipshared/b28c/hdl" +incdir+"C:/Xilinx2/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../Final_project.gen/sources_1/bd/final_block/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_vip_v1_1_17 $vlogan_opts -sverilog +incdir+"../../../../Final_project.gen/sources_1/bd/final_block/ipshared/ec67/hdl" +incdir+"../../../../Final_project.gen/sources_1/bd/final_block/ipshared/b28c/hdl" +incdir+"C:/Xilinx2/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../Final_project.gen/sources_1/bd/final_block/ipshared/4d04/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work processing_system7_vip_v1_0_19 $vlogan_opts -sverilog +incdir+"../../../../Final_project.gen/sources_1/bd/final_block/ipshared/ec67/hdl" +incdir+"../../../../Final_project.gen/sources_1/bd/final_block/ipshared/b28c/hdl" +incdir+"C:/Xilinx2/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../Final_project.gen/sources_1/bd/final_block/ipshared/b28c/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../Final_project.gen/sources_1/bd/final_block/ipshared/ec67/hdl" +incdir+"../../../../Final_project.gen/sources_1/bd/final_block/ipshared/b28c/hdl" +incdir+"C:/Xilinx2/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work generic_baseblocks_v2_1_2 $vlogan_opts +v2k +incdir+"../../../../Final_project.gen/sources_1/bd/final_block/ipshared/ec67/hdl" +incdir+"../../../../Final_project.gen/sources_1/bd/final_block/ipshared/b28c/hdl" +incdir+"C:/Xilinx2/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../Final_project.gen/sources_1/bd/final_block/ipshared/0c28/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work fifo_generator_v13_2_10 $vlogan_opts +v2k +incdir+"../../../../Final_project.gen/sources_1/bd/final_block/ipshared/ec67/hdl" +incdir+"../../../../Final_project.gen/sources_1/bd/final_block/ipshared/b28c/hdl" +incdir+"C:/Xilinx2/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work axi_data_fifo_v2_1_30 $vlogan_opts +v2k +incdir+"../../../../Final_project.gen/sources_1/bd/final_block/ipshared/ec67/hdl" +incdir+"../../../../Final_project.gen/sources_1/bd/final_block/ipshared/b28c/hdl" +incdir+"C:/Xilinx2/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../Final_project.gen/sources_1/bd/final_block/ipshared/9692/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_register_slice_v2_1_31 $vlogan_opts +v2k +incdir+"../../../../Final_project.gen/sources_1/bd/final_block/ipshared/ec67/hdl" +incdir+"../../../../Final_project.gen/sources_1/bd/final_block/ipshared/b28c/hdl" +incdir+"C:/Xilinx2/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../Final_project.gen/sources_1/bd/final_block/ipshared/92b2/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_protocol_converter_v2_1_31 $vlogan_opts +v2k +incdir+"../../../../Final_project.gen/sources_1/bd/final_block/ipshared/ec67/hdl" +incdir+"../../../../Final_project.gen/sources_1/bd/final_block/ipshared/b28c/hdl" +incdir+"C:/Xilinx2/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.final_block xil_defaultlib.glbl -o final_block_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./final_block_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key final_block_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc final_block_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./final_block.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: final_block.sh [-help]\n\
Usage: final_block.sh [-step]\n\
Usage: final_block.sh [-lib_map_path]\n\
Usage: final_block.sh [-reset_run]\n\
Usage: final_block.sh [-reset_log]\n\
Usage: final_block.sh [-keep_index]\n\
Usage: final_block.sh [-noclean_files]\n\n\
